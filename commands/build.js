...
module.exports = {
    name: 'build',
    description: "This displays the build of a champion",
    async execute(message, args){
      ...
      message.channel.startTyping(true);
        ...
        //   console.log("Loading Success");
          const shot = await page.$('.recommended-build_items')
        //   console.log(shot)
        ...
        //   Takes screenshot path.join(__dirname, `../static/images/${id}.png`)   path.join(__dirname, 'file.json')
          const imagebuffer =  await page.screenshot({ clip: {x: 392, y: 1562, width: 1014, height: 217.5}, omitBackground: true });
